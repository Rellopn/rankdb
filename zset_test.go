...
func InitZSet() *SortedSet {
	zSet := New()
	zSet.ZAdd("myzset", NewF64CompareAble(19), "ced")
	zSet.ZAdd("myzset", NewF64CompareAble(12), "acd")
	zSet.ZAdd("myzset", NewF64CompareAble(17), "bcd")
	zSet.ZAdd("myzset", NewF64CompareAble(32), "acc")
	zSet.ZAdd("myzset", NewF64CompareAble(17), "mcd")
	zSet.ZAdd("myzset", NewF64CompareAble(21), "ccd")
	zSet.ZAdd("myzset", NewF64CompareAble(18), "ecd0")
	zSet.ZAdd("myzset", NewF64CompareAble(20), "ecd1")
	zSet.ZAdd("myzset", NewF64CompareAble(24), "ecd2")
	zSet.ZAdd("myzset", NewF64CompareAble(23), "ecd3")
	zSet.ZAdd("myzset", NewF64CompareAble(25), "ecd4")
	zSet.ZAdd("myzset", NewF64CompareAble(22), "ecd5")
	zSet.ZAdd("myzset", NewF64CompareAble(35), "ecd6")
	zSet.ZAdd("myzset", NewF64CompareAble(45), "ecd7")
	zSet.ZAdd("myzset", NewF64CompareAble(55), "ecd8")
	zSet.ZAdd("myzset", NewF64CompareAble(65), "ecd9")
	zSet.ZAdd("myzset", NewF64CompareAble(75), "ecd10")
	zSet.ZAdd("myzset", NewF64CompareAble(30), "ecd11")
	zSet.ZRank("myzset", "ecd10")
	return zSet
}
...
func TestSortedSet_ZAdd(t *testing.T) {
	...
	t.Run("normal data", func(t *testing.T) {
		zSet := InitZSet()
		zSet.ZAdd("myzset", NewF64CompareAble(39), "mmd")
...
func TestSortedSet_ZRevGetByRank(t *testing.T) {
	...
	for i := 0; i < 100; i++ {
		zset.ZAdd("myzset", NewF64CompareAble(float64(rand.Intn(100000))), randomVal())
	}
...
func TestSortedSet_ZScoreRange(t *testing.T) {
	...
	zset.ZAdd(key, NewF64CompareAble(13), "aa")

	val := zset.ZScoreRange(key, NewF64CompareAble(-12), NewF64CompareAble(500))
	for _, v := range val {
		t.Logf("%+v", v)
	}
}
...
func TestSortedSet_ZRevScoreRange(t *testing.T) {
	...
	t.Run("normal", func(t *testing.T) {
		zset.ZAdd(key, NewF64CompareAble(45), "aa")

		val := zset.ZRevScoreRange(key, NewF64CompareAble(17), NewF64CompareAble(17))
		for _, v := range val {
			t.Logf("%+v", v)
		}
	})
